...
export const getRentDetailsByCarId = (carId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/${carId}/rent-details`, config);
...
export const createRent = (rent) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post("/api/rent/car/create/", rent, config);
...
export const updateCar = (car) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`/api/car/update/${car.id}/`, car, config);
...
export const getCarDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/car/${id}`, config);
...
export const listOfCarOfRents = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/rents/list/car/${id}`, config);
...
export const listOfReservations = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/list-of-reservations/cars/`, config);
...
export const createCar = (car) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post("/api/car/create/", car, config);
