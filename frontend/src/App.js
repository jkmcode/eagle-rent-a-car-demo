  ...
  return (
    <Router>
      <Routes>
        ...
        <Route exact path = '/admin/localisation' element={<Localisation />}></Route>
        <Route exact path = '/admin/createlocation' element={<NewLocation />}></Route>
        <Route exact path = '/admin/location/:id/edit' element={<LocationEdit />}></Route>
        ...
        <Route exact path = '/car/:id/show/:idLocation' element={<CarShow />}></Route>
        <Route exact path = '/car/:id/show/:action/:idLocation' element={<CarShow />}></Route>
        <Route exact path = '/car/:id/show/:action/:idLocation/id-res/:idRes' element={<CarShow />}></Route>
        <Route exact path = '/car/:id/show/:action/:idLocation/id-rent/:idRent' element={<CarShow />}></Route>
        ...
        <Route exact path = '/search/reservation/:action/' element={<SearchReservation />}></Route>

        <Route exact path = '/filter/reservation/' element={<FilterReservation />}></Route>
        
        <Route exact path = '/car/:id/reservation/id-location/:idLocation' element={<CarReservation />}></Route>
        <Route exact path = '/car/:id/reservation/id-location/:idLocation/:action' element={<CarReservation />}></Route>

        <Route exact path = '/car/:id/:idLocation/edit-reservation' element={<CarEditReservation />}></Route>

        <Route exact path = '/car/:id/rent/:idLocation' element={<CarRent />}></Route>
        <Route exact path = '/car/:id/rent/:idLocation/:action/:idRes' element={<CarRent />}></Route>


        <Route exact path = '/car/:id/rent/edit/:idRent/location/:idLocation' element={<CarRentEdit />}></Route>
        <Route exact path = '/car/:id/pick-up/:idLocation' element={<CarPickUp />}></Route>


        <Route exact path = '/reservation/car/:idLocation/:carId/:action/:id' element={<CarSingleEditReservation />}></Route>


        <Route exact path = '/mainpage/:id/car-list' element={<CarLocationList />}></Route>
        
        <Route exact path = '/upload-image/:id/' element={<UploadImage />}></Route>
        <Route exact path = '/upload-image/:id/location/' element={<UploadImageLocation />}></Route>
        <Route exact path = '/reservation-calendar' element={<ReservationCalendar />}></Route>
