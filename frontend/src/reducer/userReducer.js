...
export const userLoginReducers = (state = {}, action) =>{
    switch(action.type){
        ...
        case USER_LOGIN_SUCCESS:
            return { loading: false, userInfo: action.payload, userDateLogin: new Date() }
...
export const userUpdateProfileReducers = (state = {}, action) =>{
    switch(action.type){
        ...
        case USER_UPDATE_PROFILE_SUCCESS:
            return { loading: false, success:true, msgSuccess:true, userInfo: action.payload }

        case USER_UPDATE_PROFILE_FAIL:
            return { loading: false, msgSuccess:false, errorProfileFail: action.payload }
