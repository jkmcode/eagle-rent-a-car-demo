...
export const filterReservationsReducers = (state = { filter: {} }, action) => {
  switch (action.type) {
    case FILTER_RESERVATIONS_REQUEST:
      return { loading: true };

    case FILTER_RESERVATIONS_SUCCESS:
      return { loading: false, filter: action.payload };

    case FILTER_RESERVATIONS_FAIL:
...
export const carUpdateReservationReducers = (
  state = { reservation: {} },
  action
) => {
  switch (action.type) {
...
export const carSingleReservationReducer = (
  state = { reservation: {} },
  action
) => {
  switch (action.type) {
...
export const carsListReservationReducers = (
  state = { reservations: [] },
  action
) => {
  switch (action.type) {
