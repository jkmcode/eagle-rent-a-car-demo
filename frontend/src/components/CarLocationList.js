...
function CarLocationList() {
  ...
  const [listSwitcherReservations, setListSwitcherReservations] =
    useState(false);
  const [listSwitcherEditReservations, setListSwitcherEditReservations] =
    useState(false);
    ...
    <main>
      ...
      <FormContainer>
        {loading ? (
          ...
          <section>
            <h3>
              {CAR_LOCATION_LIST_TITLE} {locationName}
            </h3>
            {listSwitcherRent ? (
              <h4>{CAR_LOCATION_LIST_RENT_SUBTITLE}</h4>
            ) : null}
            {listSwitcherInUseSupp ? (
              <h4>{CAR_LOCATION_LIST_IN_USE_SUBTITLE}</h4>
            ) : null}
            {listSwitcherToDo ? (
              <h4>{CAR_LOCATION_LIST_TO_DO_SUBTITLE}</h4>
            ) : null}
            {listSwitcherReservations ? (
              <h4>{CAR_LOCATION_LIST_RESERVATIONS_SUBTITLE}</h4>
            ) : null}
            {listSwitcherEditReservations ? (
              <h4>{CAR_LOCATION_LIST_EDIT_RESERVATION_SUBTITLE}</h4>
            ) : null}
            ...
            <Row>
              <Col className="car-list-location-position">
                <Button
                  className={
                    listSwitcherRent
                      ? "btn-bg-car-list-location mb-1"
                      : "btn-car-list-location mb-1"
                  }
            ...
            {listSwitcherToDoSupp ? (
              <div>
                ...
                <Button
                  className={
                    filterAll
                      ? "btn-bg-car-list-location"
                      : "btn-car-list-location"
                  }
                ...
                <hr />
                <h4 className="mb-3">
                  {CAR_LOCATION_LIST_AMOUNT_OF_POSITIONS} {cars.length}
                </h4>
                {cars.map((car, index) => (
                    ...
                    <ListGroup variant="flush">
                      <ListGroup.Item
                        className={classNames("card-list-color", {
                          ...
                          "card-list-color-rent-delay":
                            car.type === CONDITION_DELAY_RENT,
                          "card-list-color-reservation":
                            car.type === CONDITION_RESERVATION,
                          "card-list-color-reservation-delay":
                            car.type === CONDITION_DELAY_RESERVATION,
                        })}
                      >
                        <Row>
                          <Col>
                            ...
                            <div>
                              <h5 className="car-registration-style">
                                {car.id_cars.code_registration}
                              </h5>
                            </div>
                            {car.type === CONDITION_RESERVATION ||
                            car.type === CONDITION_DELAY_RESERVATION ? (
                              <div>
                                <h6 className="reservation-from-title">
                                  {
                                    CAR_LOCATION_LIST_EDIT_RESERVATION_FROM_SUBTITLE
                                  }
                                </h6>
                              ...
                              {index + 1 === iterator ? (
                                <div>
                                  ...
                                  <div>
                                    ...
                                    <h6>
                                      {car.client_document_type},{" "}
                                      {CAR_LOCATION_LIST_CONTACT_INFO_ID_NO}{" "}
                                      {car.client_document_identification}
                                    </h6>
                                    <h6>
                                      {CAR_LOCATION_LIST_CONTACT_INFO_TEL}{" "}
                                      {car.client_phone}
                                    ...
                                    {car.type === CONDITION_RENT ? (
                                      <div>
                                        <h6>
                                          ...
                                          {car.deposit} {car.deposit_currency}
                                        </h6>
                                        <h6>
                                          {
                                            CAR_LOCATION_LIST_CONTACT_INFO_TOTAL_PRICE
                          ...
                          <Col className="carslist-position">
                            ...
                            car.type === CONDITION_DELAY_RESERVATION ? (
                              <div>
                                <div>
                                  <LinkContainer
                                    to={`/reservation/car/${locationId}/${car.id_cars.id}/${action}/${car.id}`}
                                  >
                                    <Button
                                      variant="warning"
                                      className="btn-md"
                                ...
                                <div className="mt-1">
                                  <LinkContainer
                                    to={`/car/${car.id_cars.id}/rent/${locationId}/${actionResToRent}/${car.id}`}
                                  >
                            ...
                            car.type === CONDITION_DELAY_RENT ? (
                              <div>
                                <div>
                                  <LinkContainer
                                    to={`/car/${car.id_cars.id}/pick-up/${locationId}`}
                                  >
                                ...
                                <div className="mt-1">
                                  <LinkContainer
                                    to={`/car/${car.id_cars.id}/rent/edit/${car.id}/location/${locationId}`}
                                  >
                                    <Button
                                      variant="warning"
                                      className="btn-md"
                        ...
                        <Row>
                          ...
                          <Col className="carslist-position">
                            <section>
                              <div className="mt-1">
                                <LinkContainer
                                  to={`/car/${car.id_cars.id}/show/in-use/${locationId}`}
                                >
                                  <Button variant="info" className="btn-md">
                              ...
                              <div>
                                ...
                                >
                                  <Button
                                    variant="success"
                                    className="btn-md btn-pickup mt-1"
                                  >
                                    <FontAwesomeIcon
                                      icon={faArrowAltCircleLeft}
                                    />{" "}
                          ...
                          <Col className="carslist-position">
                            ...
                            {listSwitcherInUse ? (
                              <section>
                                <div>
                                  <LinkContainer
                                    to={`/car/${car.id}/pick-up/${locationId}`}
                                  >
                                    <Button
                                      variant="warning"
                            ...
                            {listSwitcherReservations ? (
                              <div>
                                <LinkContainer
                                  to={`/car/${car.id}/show/id-location/${locationId}`}
                                >
                                  <Button variant="warning" className="btn-md">
                            ...
                            {listSwitcherEditReservations ? (
                              <div>
                                <LinkContainer
                                  to={`/car/${car.id}/${locationId}/edit-reservation`}
                                >
                                  <Button variant="warning" className="btn-md">
