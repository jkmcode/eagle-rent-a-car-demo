...
function CarPickUp() {
  ...
  useEffect(() => {
    ...
    if (carUpdateError || error) {
      if (
        carUpdateError === REQUEST_FAILED_WITH_STATUS_CODE_500 ||
  ...
  return (
    <main>
      ...
      <FormContainer>
        {pickUpMsgSuccess && (
          <Message variant="success">{pickUpMsgSuccess}</Message>
        )}
            ...
            {rent.client_name ? (
              <div>
                ...
                {generalInfo ? (
                  <div>
                    <h5>
                      {CAR_PICK_UP_CLIENT_NAME} {rent.client_name}
                    </h5>
                    <h5>
                    ...
                    <h5>
                      {CAR_PICK_UP_PHONE} {rent.client_phone}
                    </h5>
                    {rent.client_email ? (
                      <h5>
                        {CAR_PICK_UP_EMAIL} {rent.client_email}
                      </h5>
                    ) : null}
                    <h5>
                      {CAR_PICK_UP_DATE_FROM}
                ...
                {paymentInfo ? (
                  <div>
                    <h5>
                      {CAR_PICK_UP_DEPOSIT} {rent.deposit}{" "}
                      {rent.deposit_currency}
                    </h5>
                    {!rent.total_price_is_paid ? (
                      <h5>
                        {CAR_PICK_UP_TOTAL_PRICE} {rent.total_price}{" "}
                ...
                <Form onSubmit={handleSubmit(submitHandler)}>
                  <Form.Group controlId="deposit">
                    ...
                    <Row>
                      ...
                      <Col md={4} xs={4}>
                        ...
                        {!isAccounted ? (
                          <p className="form-msg-style">{isAccountedMsg}</p>
                        ) : null}
                      </Col>
                    </Row>
                  </Form.Group>
                  <Form.Group controlId="totalPrice">
                    <Row>
                      ...
                      <Col md={4} xs={4}>
                        ...
                        {!isAccountedTotalPrice ? (
                          <p className="form-msg-style">
                            {isAccountedTotalPriceMsg}
                          </p>
                        ) : null}
                      </Col>
                    </Row>
                  ...
                  <Button type="submit" className="rounded btn-pickup my-3">
