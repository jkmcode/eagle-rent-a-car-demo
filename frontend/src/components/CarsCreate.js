  ...
  return (
    <main>
      ...
      <FormContainer>
        ...
        {errorUploadImage && (
          <Message variant="info">{errorMessageImage}</Message>
        )}
        <Row>
          <Col>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Form.Group controlId="shortName">
            ...
            {carShortName ? (
              <p className="docTypeMessage-style">{carShortName}</p>
            ) : null}
          </Form.Group>
          ...
          <Form.Group controlId="codeRegistration">
            ...
            {codeRegistration ? (
              <p className="docTypeMessage-style">{codeRegistration}</p>
            ) : null}
          </Form.Group>
          ...
          <Form.Group controlId="selectLocation">
            ...
            {locatisationMessage ? (
              <p className="docTypeMessage-style">{locatisationMessage}</p>
            ) : null}
          </Form.Group>
