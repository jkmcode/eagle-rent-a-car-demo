                    ...
                    <section>
                      <Row>
                        <Col>
                          ...
                          <h4> {car.name}</h4>
                          <h5> {CAR_EDIT_RESERVATION_NO_RESERVATION_TITLE} {car.code_registration}</h5>
                        </Col>
                        <Col className='right-position'>
                          ...
                          <LinkContainer to={`/car/${car.id}/show/rent/${locationId}/${actionEditList}`}>
                            <Button 
                              variant='info' 
                        ...
                        <Card key={res.id} className='mb-3 card-edit-reservation'>
                          <Row>
                            <Col>
                              ...
                              <div>
                                <hr />
                                <div>{CAR_EDIT_RESERVATION_PHONE_NO} {res.client_phone}</div>
                                {res.client_email
                                  ? <div>{CAR_EDIT_RESERVATION_EMAIL} {res.client_email}</div>
                                  : null
                                }
                            ...
                            <Col className='carslist-edit-reservation'>
                              <LinkContainer to={`/reservation/car/${locationId}/${carId}/${action}/${res.id}`}>
                                <Button 
                                  variant='warning' 
                                  className='btn-md'
                                >
