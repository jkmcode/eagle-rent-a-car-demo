...
function SearchReservation() {
  ...
  const SubmitStartTime = (time) => {
    ...
    setStartTimeValue(
      new Date(`01/02/2021 ${getTime.getHours()}:${getTime.getMinutes()}`)
    );
  ...
  const submitHandler = () => {
    ...
    if (!startDateTimeCombiner) {
      ...
      startDateTimeCombiner.valueOf() - MIN_DURATION <
      new Date().valueOf()
    ) {
              ...
              <Form.Group controlId="datePicker">
                <Row>
                  ...
                  <Col md={2} xs={4}>
                    ...
                    />
                    {selectStartTimeMsg ? (
                      <p className="docTypeMessage-style">
                        {selectStartTimeMsg}
                      </p>
                    ) : null}
                  </Col>
                  {wrongStartDateMsg ? (
                    <p className="docTypeMessage-style">{wrongStartDateMsg}</p>
                  ) : null}
                  ...
                  {wrongEndDateMsg ? (
                    <p className="docTypeMessage-style">{wrongEndDateMsg}</p>
                  ) : null}
                </Row>
                          ...
                          <ListGroup.Item className="card-car-admin-bg">
                            <Row>
                              <Col>
                                ...
                                {locations.map((loc) =>
                                  loc.id == car.location ? (
                                    <h5
                                      key={loc.id}
                                      className="car-registration-style"
                                    >
                              ...
                              <Col className="carslist-position">
                                <div>
                                  <LinkContainer
                                    to={`/car/${car.id}/show/search-reservation/`}
                                  >
                                    <Button
                                      variant="warning"
                                      className="btn-md"
