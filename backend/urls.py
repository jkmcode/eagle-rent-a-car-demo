...
urlpatterns = [
    ...
    path('api/users/login/', views.MyTokenObtainPairView.as_view(), name='token_refresh'),
    ...
    #path('api/users/login/', views.userLogin, name='userLogin'),

    #locations
    path('api/cars/upload/', views.locationUploadImage, name='location-upload-image'),
    ...
    path('api/new/location/upload/', views.newLocationUploadImage, name='location-update'),
    ...
    #carListByLocation 
    path('mainpage/<str:pk>/car-list/to-rent/', views.getCarListByLocationToRent, name='get-carlist-by-location-to-rent'),
    path('mainpage/<str:pk>/car-list/in-use/', views.getCarListByLocationInUse, name='get-carlist-by-location-in-use'),
    path('mainpage/<str:pk>/car-list/to-do/', views.getCarListByLocationToDo, name='get-carlist-by-location-to-do'),
    path('mainpage/<str:pk>/car-list/reservations/', views.getCarListByLocationReservations, name='get-carlist-by-location-reservations'),
    path('mainpage/<str:pk>/car-list/new-reservation/', views.getCarListByLocationNewReservations, name='get-carlist-by-location-new-reservation'),
    ...
    path('api/reservation/delete/<str:pk>/', views.deleteReservation, name='reservation-delete'),
    path('api/car/single/reservation/<str:pk>/edit/', views.getReservationById, name='get-reservation-by-id'),
    path('api/reservation/update/<str:pk>/', views.updateReservation, name='update-reservation'),
